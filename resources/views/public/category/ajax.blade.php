    ...
    <div class="men-pro-item simpleCart_shelfItem">
        <div class="men-thumb-item">
            @if (count($val->gallery) > 0)
                <img src="{{ asset('product/thumbnails/' . $val->gallery[0]->image) }}"  style="width:170px"
                    alt="{{ $val->gallery[0]->image }}">
            @else
            ...
            <div class="men-cart-pro">
                <div class="inner-men-cart-pro">
                    <a href="{{ url('home/' . $val->slug) }}"
                        class="link-product-add-cart">Chi
                        tiết</a>
                </div>
            </div>
        ...
        <div class="item-info-product ">
            ...
            <div class="info-product-price">
                <span class="item_price">{{ number_format($val->price, 0, ',', '.') }}
                    VNĐ</span>
                @if ($val->sale)
